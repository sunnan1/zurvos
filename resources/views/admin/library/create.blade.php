@extends('admin.layouts.app')
 ...
 <div class="signup-form" style="align-self: center;">
             <form action="{{Route('exercise-lib.store')}}" method="post" enctype="multipart/form-data">
                       <h2 style="font-size: 22px; text-align: center;"><strong>Add New Library</strong></h2>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                          ...
                          <label style="color: black"> Video Tags</label>
                            <input type="text" class="form-control" id="selected" name="tags" >
</div>
<div class="col-md-3">
                        ...
                        <div class="form-group">
                         <label style="color: black"> Select Customer</label>
                            <select data-plugin="customselect" name="customer" class="form-control">
                                ...
                                <option value="{{$influence->id}}">{{$influence->full_name}}</option>
                                @endforeach
   ...
   <div class="form-group">
                        ...
                        <div class="form-group">
                            <button style="font-size: 14px" type="submit" class="btn btn-primary btn-block btn-lg">ADD LIBRARY</button>
                        </div>
                    </form>
