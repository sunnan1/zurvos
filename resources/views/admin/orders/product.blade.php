@extends('admin.layouts.app')
  ...
  <ul class="dropdown-menu">
    ...
    <li><a href="{{route('product-orders.destroy',$order->id)}}" class="dropdown-item" onclick="
                   ...
                   ">Delete</a>
                                                     ...
                                                     <form id="delete-form-{{$order->id}}" action="{{route('product-orders.destroy',$order->id)}}" method="post" style="display:none">
                             @csrf
                            @method('DELETE')
                            </form>    
